(function ($) {
    ...
    $.fn.tablemanager = function (options = null) {
        ...
        **/
        ...
        var currentPage = 0;
        var numPerPage =
            pagination !== true && showrows_option !== true ? rows.length : 100;
        var numOfPages = options.numOfPages !== undefined && options.numOfPages > 0 ? options.numOfPages : 100;
      ...
      var defaultNumPerPage = 100;
        ...
        **/
        function generatePaginationValues() {
            ...
            numPerPage = selectNumRowsVal || defaultNumPerPage; // Use default if not provided
            ...
            // Give currentPage class to the first page number
