 ...
 */
class MultipartStream implements \_PhpScoper5f636c07d0f55\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoper5f636c07d0f55\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoper5f636c07d0f55\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoper5f636c07d0f55\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
