 ...
 */
class FnStream implements \_PhpScoper5f636c07d0f55\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoper5f636c07d0f55\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
