 ...
 */
class LimitStream implements \_PhpScoper5f636c07d0f55\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoper5f636c07d0f55\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
