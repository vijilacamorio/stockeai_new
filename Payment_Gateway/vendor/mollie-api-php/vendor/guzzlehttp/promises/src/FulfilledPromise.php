 ...
 */
class FulfilledPromise implements \_PhpScoper5f636c07d0f55\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoper5f636c07d0f55\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
