      ...
      <div class="description" >
        <h2 style="margin-bottom:20px;"><?php echo $company; ?> </h2>
                ...
                <div class="col-md-4 col-sm-4 mb-30 invoice-contact-us">
                        <h4 class="inv-title-1" style="font-weight:bold;color:<?php echo $color; ?> "><?php  echo $expense_pdf[0]['emp_name'];  ?></h4>
                                        <!--<h4 class="inv-title-1" style="font-weight:bold;color:<?php// echo $color; ?> "><?php //echo $business_name; ?></h4>-->
                                        <h2 class="name mb-10"></h2>
                                        <ul class="link">
                                            <li>
                                            <strong>Expense Date :</strong><?php echo $expense_pdf[0]['expense_payment_date']; ?>
                                            </li>
                                            <!-- <li>-->
                                         ...
                                         <li>
                                            ...
                                            <li>
                                               <strong>Amount    :</strong><?php  echo $currency; ?><?php echo $expense_pdf[0]['expense_amount']; ?>
                                            </li>
                                            
                                    
                                           
                                             <li>
                                               <strong>Expense Payment Date   :</strong><?php echo $expense_pdf[0]['expense_payment_date']; ?>
                                            </li>
                                        
                                        </ul>
                                        <br/>
                                        <strong>Description :</strong><?php echo $expense_pdf[0]['description']; ?>
                                    </div>
...
setTimeout( function(){
 ...
 for (var i = 1; i <= totalPages; i++) {
  ...
  }).save('Expense'+'<?php  echo $expense_pdf[0]['emp_name'];  ?>'+'pdf');
    callback1();
    callback2();
 }, 3000 );
}
