   ...
   <section class="content">
      ...
      <div class="col-sm-16 col-md-14">
            <div class="panel panel-bd lobidrag" style='height:80px; border: 3px solid #d7d4d6;'>
                <div class='col-sm-8'>
                 <form id="fetch_tax" action="<?php echo base_url(); ?>Chrm/medicare_tax_report" method="POST">
...
?>
        <tr>
            ...
            <td><?php echo number_format($f_tax['m_mtax'], 2); ?></td>
...
?>
 ...
 $i=0;
  $index = 0;
    foreach($fed_tax as $f_tax) {
         $s_stax_emplr = isset($fed_tax_emplr[$index]['m_mtax']) ? $fed_tax_emplr[$index]['m_mtax'] : 0;
        $employeeContributionTotal += $f_tax['m_mtax'];
...
//             stx=0;
//           }
//           totalSStax += parseFloat(item.m_mtax);
...
//           row += "<td style='text-align: center;'>" +item.m_mtax + "</td>"; // Add currency symbol here
