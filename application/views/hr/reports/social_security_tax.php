   ...
   <section class="content">
      ...
      <div class="col-sm-16 col-md-14">
            <div class="panel panel-bd lobidrag" style='height:80px; border: 3px solid #d7d4d6;'>
                <div class='col-sm-8'>
                    <form id="fetch_tax" action="<?php echo base_url(); ?>Chrm/social_tax_report" method="POST">
                  ...
                  <tr style='text-align:center;font-weight:bold;' class="filters">
                     ...
                     <td class="search_dropdown" style="width: 15%; color: black; position: relative; top: 4px;">
                        <div id="datepicker-container">
                           <input type="text" class="form-control daterangepicker-field getdate_reults" id="daterangepicker-field" name="daterangepicker-field" style="margin-top: 15px;padding: 5px; width: 200px; border-radius: 8px; height: 35px;" value="<?php echo isset($start) ? $start." - ".$end : ''; ?>" />
                        </div>
                     </td>
...
?>
        <tr>
            ...
            <td><?php echo number_format($f_tax['s_stax'], 2); ?></td>
...
//         type: "POST",
//         dataType: "json",
//         url: "<?php echo base_url(); ?>Chrm/social_tax_report",
//         data: dataString,
