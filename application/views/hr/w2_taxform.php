...
<?php echo !empty($matchedCode) ? htmlspecialchars($c_details[0]['State_Tax_ID_Number'], ENT_QUOTES, 'UTF-8') : ''; ?>
               ...
               <?php  if($gettaxdata[0]['payroll_type'] == 'Hourly') {
                ...
                ?>
                  <?php
                   $overalltotal_statetax1 = isset($stateTax[0]['overalltotal_statetax0']) ? number_format($stateTax[0]['overalltotal_statetax0'], 2) : '0';
                  ?>
                  <?php
                  $overalltotal_statetaxworking1 = isset($stateworkingtax[0]['overalltotal_statetaxworking']) ? number_format($stateworkingtax[0]['overalltotal_statetaxworking'], 2) : '0';
                  ?>
               <p style="position:absolute;top:434px;left:427px;white-space:nowrap" class="ft32"><b>17 &#160;</b>State income tax 
                  <br> <span style="color: #000; font-size: 14px;position: relative;left: 37px;">
                  <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $overalltotal_statetax1, ENT_QUOTES, 'UTF-8') : ''; ?> 
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;">
                  <?php echo !empty($matchedCode1) ? htmlspecialchars($currency . $overalltotal_statetaxworking1, ENT_QUOTES, 'UTF-8') : ''; ?>  
                  </span> 
               </p>
...
<?php  if($gettaxdata[0]['payroll_type'] == 'Hourly') {
               ...
               <?php
                  ...
                  ?>
                  <?php
                   $overalltotal_statetax2 = isset($stateTax[0]['overalltotal_statetax0']) ? number_format($stateTax[0]['overalltotal_statetax0'], 2) : '0';
                  ?>
                  <?php
                  $overalltotal_statetaxworking2 = isset($stateworkingtax[0]['overalltotal_statetaxworking']) ? number_format($stateworkingtax[0]['overalltotal_statetaxworking'], 2) : '0';
                  ?>
               <p style="position:absolute;top:434px;left:427px;white-space:nowrap" class="ft41"><b>17 &#160;</b>State income tax 
                  <br> <span style="color: #000; font-size: 14px;position: relative;left: 37px;">
                  <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $overalltotal_statetax2, ENT_QUOTES, 'UTF-8') : ''; ?>   
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;">
                  <?php echo !empty($matchedCode1) ? htmlspecialchars($currency . $overalltotal_statetaxworking2, ENT_QUOTES, 'UTF-8') : ''; ?>    
                  </span> 
               </p>
...
?>
               ...
               <?php
                  ...
                  ?>
                    <?php
                   $overalltotal_statetax3 = isset($stateTax[0]['overalltotal_statetax0']) ? number_format($stateTax[0]['overalltotal_statetax0'], 2) : '0';
                  ?>
                  <?php
                  $overalltotal_statetaxworking3 = isset($stateworkingtax[0]['overalltotal_statetaxworking']) ? number_format($stateworkingtax[0]['overalltotal_statetaxworking'], 2) : '0';
                  ?>
               <p style="position:absolute;top:434px;left:427px;white-space:nowrap" class="ft61"><b>17 &#160;</b>State income tax 
                 <br> <span style="color: #000; font-size: 14px;position: relative;left: 37px;">
                  <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $overalltotal_statetax3, ENT_QUOTES, 'UTF-8') : ''; ?>   
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;">
                  <?php echo !empty($matchedCode1) ? htmlspecialchars($currency . $overalltotal_statetaxworking3, ENT_QUOTES, 'UTF-8') : ''; ?>  
                  </span> 
               </p>
...
?>             
               ...
               <?php
                  ...
                  ?>
                        <?php
                   $overalltotal_statetax4 = isset($stateTax[0]['overalltotal_statetax0']) ? number_format($stateTax[0]['overalltotal_statetax0'], 2) : '0';
                  ?>
                  <?php
                  $overalltotal_statetaxworking4 = isset($stateworkingtax[0]['overalltotal_statetaxworking']) ? number_format($stateworkingtax[0]['overalltotal_statetaxworking'], 2) : '0';
                  ?>
               <p style="position:absolute;top:434px;left:427px;white-space:nowrap" class="ft81"><b>17 &#160;</b>State income tax 
                  <br> <span style="color: #000; font-size: 14px;position: relative;left: 37px;">
                  <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $overalltotal_statetax4, ENT_QUOTES, 'UTF-8') : ''; ?>   
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;">
                  <?php echo !empty($matchedCode1) ? htmlspecialchars($currency . $overalltotal_statetaxworking4, ENT_QUOTES, 'UTF-8') : ''; ?>  
                  </span> 
               </p>
...
?>             
               ...
               <?php
                  ...
                  ?>
                                          <?php
                   $overalltotal_statetax5 = isset($stateTax[0]['overalltotal_statetax0']) ? number_format($stateTax[0]['overalltotal_statetax0'], 2) : '0';
                  ?>
                  <?php
                  $overalltotal_statetaxworking5 = isset($stateworkingtax[0]['overalltotal_statetaxworking']) ? number_format($stateworkingtax[0]['overalltotal_statetaxworking'], 2) : '0';
                  ?>
               <p style="position:absolute;top:434px;left:427px;white-space:nowrap" class="ft102"><b>17 &#160;</b>State income tax 
                  <br> <span style="color: #000; font-size: 14px;position: relative;left: 37px;">
                   <?php echo !empty($matchedCode) ? htmlspecialchars($currency . $overalltotal_statetax5, ENT_QUOTES, 'UTF-8') : ''; ?> 
                  </span>
                  <span style="color: #000; font-size: 14px; position: relative; top: 30px;">
                  <?php echo !empty($matchedCode1) ? htmlspecialchars($currency . $overalltotal_statetaxworking5, ENT_QUOTES, 'UTF-8') : ''; ?>    
                  </span> 
               </p>
