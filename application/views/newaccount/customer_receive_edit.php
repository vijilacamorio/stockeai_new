...
<?php
   ...
   $CI->load->model('Accounts_model');
    ...
    $customer_name = $this->db->select('customer_name')->from('customer_information')->where('customer_id', $customer_receive_edit[0]['account_name'])->get()->row()->customer_name;
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo ('Edit Customer Receive') ?></h1>
            <small><?php //echo display('debit_voucher') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active" style="color:orange"><?php echo  "Edit Customer Receive" ?></li>
            </ol>
        </div>
    </section>
...
<div class="col-sm-12 col-md-12">
    ...
    <div class="panel panel-bd lobidrag">
        ...
        <div class="panel-heading" style='height: 50px;'>
            ...
            <div class="panel-title">
                ...
                <h4>
                  ...
                  <?php echo display('Customer Receive')?>   
                  <a   href="<?php echo base_url('accounts/customer_receive_manager') ?>" class="btnclr btn  m-b-5 m-r-2" style="color:white;float:right;" ><i class="ti-align-justify"> </i> <?php echo ('Manage Customer Receive') ?> </a>
        ...
        <div class="panel-body">
          ...
          <?php //print_r($customer_receive_edit);  ?>

                     <?php echo  form_open_multipart('accounts/update_customer_receive','id="validate"') ?>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                         ...
                         <input type="text" name="txtVNo" id="txtVNo" value="<?php echo $customer_receive_edit[0]['voucher_no']; ?>" class="form-control" readonly placeholder="Voucher No">
                     </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                         ...
                         <input type="date" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo $customer_receive_edit[0]['date']; ?>" required>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <option  value="<?php if($customer_receive_edit[0]['pay_type']=='2'){ echo '2';}elseif($customer_receive_edit[0]['pay_type']=='1'){ echo  '1';} ?>"  ><?php if($customer_receive_edit[0]['pay_type']=='2'){  echo display('bank_payment');}elseif($customer_receive_edit[0]['pay_type']=='1'){ echo display('cash_payment');} ?></option>
...
<input type="hidden"  name="cust_incremnt_id" value="<?php echo $customer_receive_edit[0]['cust_incremnt_id']; ?>" >
                     ...
                     <option value="<?php echo $customer_receive_edit[0]['bank']; ?>"><?php echo $customer_receive_edit[0]['bank']; ?></option>
...
<option value="SoFi">SoFi</option>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input  name="txtRemarks" id="txtRemarks" value="<?php echo $customer_receive_edit[0]['remark']; ?>" class="form-control"></input>
...
<th class="text-center"><?php echo display('amount')?><i class="text-danger">*</i></th>
   ...
   <option value="<?php echo $customer_receive_edit[0]['account_name']; ?>"><?php echo $customer_name; ?></option>
...
<option value="<?php echo html_escape($customer->customer_id);?>"><?php echo html_escape($customer->customer_name);?></option>
 <?php }?>
                                    ...
                                    <td><input type="text" name="txtCode" value="<?php echo $customer_receive_edit[0]['account_id']; ?>" class="form-control "  id="txtCode_1" readonly=""></td>

                                    <td style="width:600px;"><span class="input-symbol-euro"><input type="number" name="txtAmount" style="width:600px;text-align:start;padding-left: 20px;" placeholder="0.00"  value="<?php echo $customer_receive_edit[0]['g_total1']; ?>" class="form-control total_price text-right"  id="txtAmount_1" onkeyup="supplierRcvcalculation(1)" required></span>
                                ...
                                <tr>
                                  ...
                                  <td >
                                    ...
                                    <td class="text-right">
                                      ...
                                      <span class="input-symbol-euro">  <input type="text" id="grandTotal" class="form-control text-right " name="grand_total" value="<?php echo $customer_receive_edit[0]['gtotal']; ?>" placeholder="0.00"  readonly="readonly" style="width:600px;text-align:start;padding-left: 20px;" /></span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 text-left">
                            ...
                            <input type="submit" id="add_receive" style="color:white;" class="btnclr btn btn-success btn-large" name="save" value="<?php echo display('save') ?>" tabindex="9"/>
