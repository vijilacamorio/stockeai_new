    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         <?php echo  form_open_multipart('accounts/edit_journal_voucher','id="validate"') ?>
                    ...
                    <div class="form-group row">
                       ...
                       <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                <thead>
                                    <tr>
                                <th class="text-center"> <?php echo 'Account Name';?><i class="text-danger">*</i></th>
                                <th class="text-center"> <?php echo 'Code'?></th>
                                <th class="text-center" style="width:400px;"> <?php echo 'Debit'?></th>
                                <th class="text-center" style="width:400px;"> <?php echo 'Credit'?></th>
