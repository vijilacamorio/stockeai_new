...
<div class="content-wrapper">
    <section class="content-header" style='height:70px;'>
        ...
        <div class="header-title">
            <h1><?php echo ('Credit Voucher') ?></h1>
            <small><?php //echo display('journal_voucher') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active" style="color:orange"><?php echo ('Credit Voucher'); ?></li>
            </ol>
        </div>
    </section>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         <?php echo  form_open_multipart('accounts/update_credit_voucher','id="validate"') ?>
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          ...
                          <option value='<?php  echo $acc[0]['pay_type'] ; ?>'><?php  echo $acc[0]['pay_type'] ; ?></option>
   ...
   <option value="<?php echo $acc1['ac_name'];?>"><?php echo $acc1['ac_name'];?></option>
         <?php }?>
                                        ...
                                        <td><input type="text" name="txtCode[]"  class="bnk_name form-control "  id="txtCode_1" readonly value='<?php   echo $jv['bank_name']; ?>'></td>
                                        <td><span class="input-symbol-euro"><input type="number" name="txtAmount[]" value='<?php   echo $jv['credit']; ?>'  placeholder="0.00" class="form-control total_price text-left"  id="txtAmount_1" onkeyup="calculationContravoucher(1)" ></span>
                                           </td>
...
<script>
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
          ...
          newdiv.innerHTML ="<td> <select name='cmbCode[]' id='cmbCode_"+ count +"' class='ac_name form-control'  required><option value=''>Select Account Name</option><?php foreach ($ac_detail as $acc1) { ?><option value='<?php echo $acc1['ac_name'];?>'><?php echo $acc1['ac_name'];?></option><?php } ?></select></td><td><input type='text' name='txtCode[]' class='bnk_name form-control'  readonly id='txtCode_"+ count +"' ></td><td  class='text-left' style='text-align:center;'><span class='input-symbol-euro'><input type='number' name='txtAmount[]' class='form-control total_price text-right' id='txtAmount_"+ count +"' onkeyup='dbtvouchercalculation("+ count +")' value='0.00' style='text-align: initial;' required></span></td><td style='text-align:center;' ><button class='btn btn-danger red' type='button'  onclick='deleteRowdbtvoucher(this)'><i class='fa fa-trash-o'></i></button></td>";
