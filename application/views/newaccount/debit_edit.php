...
<div class="content-wrapper">
    <section class="content-header" style='height:70px;'>
        ...
        <div class="header-title">
            <h1><?php echo ('Debit Voucher') ?></h1>
            <small><?php //echo display('journal_voucher') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active" style="color:orange"><?php echo ('Debit Voucher'); ?></li>
            </ol>
        </div>
    </section>
    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         <?php echo  form_open_multipart('accounts/update_debit_voucher','id="validate"') ?>
   ...
   <option value="<?php echo $acc1['ac_name'];?>"><?php echo $acc1['ac_name'];?></option>
         <?php }?>
                                        ...
                                        <td><span class="input-symbol-euro"><input type="number" name="txtAmount[]" value='<?php   echo $jv['debit']; ?>'  placeholder="0.00" class="form-control total_price text-left"  id="txtAmount_1" onkeyup="calculationContravoucher(1)" ></span>
                                           ...
                                           <!-- <td ><span class="input-symbol-euro"><input type="number" name="txtAmountcr[]" value='<?php   echo $jv['debit']; ?>'  placeholder="0.00" class="form-control total_price1 text-left"  id="txtAmount1_1" onkeyup="calculationContravoucher(1)" ></span>-->
                                           <!--</td>-->
