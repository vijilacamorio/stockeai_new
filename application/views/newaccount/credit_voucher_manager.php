...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo ('Credit Voucher Manager') ?></h1>
            <small><?php //echo display('debit_voucher') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active" style="color:orange"><?php echo  "Credit Voucher Manager" ?></li>
            </ol>
        </div>
    </section>
...
<div class="col-sm-4" style="display: flex; justify-content: space-between; align-items: left;">
                                 ...
                                 <a href="<?php echo base_url('accounts/credit_voucher') ?>" class="btnclr btn btn-default dropdown-toggle boxes filip-horizontal"   style="height:fit-content;"  ><i class="far fa-file-alt"> </i> <?php echo ('Create Credit Voucher ') ?> </a>
                    ...
                    <tr>
                        ...
                        <td><?php  echo $j->voucher_no;  ?></td>
                          <td><?php  echo $j->date;  ?></td>
                            ...
                            <td >     <a class="btnclr btn  btn-sm invoice_edit"  style="background-color: #3ca5de; color: #fff;" href="<?php echo base_url()?>accounts/edit_credit_voucher/<?php echo  $j->cust_incremnt_id;  ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
