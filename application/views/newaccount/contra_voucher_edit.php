        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
               <div class="panel-title" style='text-align:end;'>
                      <a  class="btnclr btn btn-default dropdown-toggle  boxes filip-horizontal "  href="<?php echo base_url('accounts/contra_voucher_manager') ?>" style="background-color: #3CA5DE; color: #fff; height:fit-content;"  id="s_icon">Manage Journal Voucher  </a>
                    <!--<h4>-->
            ...
            <div class="panel-body">
                         <?php echo  form_open_multipart('accounts/edit_contra_voucher','id="validate"') ?>
                     <div class="form-group row">
                        <label for="vo_no" class="col-sm-2 col-form-label"><?php echo display('voucher_no')?><i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                             <input type="text" name="txtVNo" id="txtVNo" value="<?php  echo $acc[0]['voucher_no']?>" class="form-control" readonly required>
                        </div>
                    </div> 
                       <input type="hidden" name="uniq_id" id="uniq_id" value="<?php  echo $acc[0]['cust_incremnt_id']?>" class="form-control">
                     <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                     <div class="form-group row">
                        <label for="date" class="col-sm-2 col-form-label"><?php echo display('date')?><i class="text-danger">*</i></label>
                        <div class="col-sm-4">
                             <input type="date" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php  echo $acc[0]['date']?>" required>
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="txtRemarks" class="col-sm-2 col-form-label"><?php echo display('remark')?></label>
                        <div class="col-sm-4">
                          <textarea  name="txtRemarks" id="txtRemarks" class="form-control"><?php  echo $acc[0]['remark']?></textarea>
                        </div>
                    </div> 
                       <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="debtAccVoucher"> 
                                ...
                                <tbody id="debitvoucher">
                                   <?php   foreach($acc as $jv){ ?>
                                    <tr>
                                        <td class="" width="300px">  
       <select name="cmbCode[]" id="cmbCode_1" class="ac_name form-control"  required="">
       <option value="<?php  echo $jv['account_name']  ?>"><?php  echo $jv['account_name']  ?></option>
         <?php foreach ($ac_detail as $acc1) {?>
   <option value="<?php echo $acc1['ac_name'];?>"><?php echo $acc1['ac_name'];?></option>
         <?php }?>
       </select>

                                         </td>
                                        <td><input type="text" name="txtCode[]"  class="bnk_name form-control "  id="txtCode_1"  value='<?php   echo $jv['bank_name']; ?>'></td>
                                        <td><span class="input-symbol-euro"><input type="number" name="txtAmount[]" value='<?php   echo $jv['debit']; ?>'  placeholder="0.00" class="form-control total_price text-left"  id="txtAmount_1" onkeyup="calculationContravoucher(1)" ></span>
                                           </td>
                                            <td ><span class="input-symbol-euro"><input type="number" name="txtAmountcr[]" value='<?php   echo $jv['credit']; ?>'  placeholder="0.00" class="form-control total_price1 text-left"  id="txtAmount1_1" onkeyup="calculationContravoucher(1)" ></span>
                                           </td>
                             ...
                             <tfoot>
                                    <tr>
                                      <td >
                                        ...
                                        <td  class="text-left">
                                          <span class="input-symbol-euro">  <input type="text" id="grandTotal"  class="form-control text-left " name="grand_total" value="<?php  echo $acc[0]['g_total1'] ; ?>" readonly="readonly" placeholder="0.00"/></span>
                                        </td>
                                         <td  class="text-left">
                                          <span class="input-symbol-euro">  <input type="text" id="grandTotal1"  class="form-control text-left " name="grand_total1" value="<?php  echo $acc[0]['g_total2'] ; ?>" readonly="readonly" placeholder="0.00"/></span>
                                        </td>
