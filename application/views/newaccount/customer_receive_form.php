...
$voucher_n = 'CUSRESV-' . $newNumericPart;
?>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                             ...
                             <input type="date" name="dtpDate" id="dtpDate" class="form-control datepicker"  required>
...
<option value="SoFi">SoFi</option>
                       ...
                       <option value="<?php echo html_escape($customer->customer_id);?>"><?php echo html_escape($customer->customer_name);?></option>
                             ...
                             <?php }?>
                                        ...
                                        <td style="width:600px;">    <span class="input-symbol-euro"><input type="number" name="txtAmount" style='text-align:left;' placeholder="0.00" class="form-control total_price text-right"  id="txtAmount_1" onkeyup="CustomerRcvcalculation(1)" required></span>
                                    ...
                                    <tr>
                                      ...
                                      <td >
                                        ...
                                        <td class="text-left" style="width:600px;">
                                               ...
                                               <span class="input-symbol-euro"> <input type="text" style='text-align:left;' id="grandTotal" placeholder="0.00" class="form-control text-right " name="grand_total" value="" readonly="readonly" /></span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 text-left">
                                ...
                                <input type="submit" id="add_receive" class="btnclr btn btn-success btn-large" style="color:white;" name="save" value="<?php echo display('save') ?>" tabindex="9"/>
