...
<div class="content-wrapper">
   <section class="content-header">
      <div class="header-icon">
         ...
         <figure class="one">
               <img src="<?php echo base_url()  ?>asset/images/trialbalance (1).png"  class="headshotphoto" style="height:50px;" />
      </div>

          <div class="header-title">
          <div class="logo-holder logo-9">
          <h1><?php echo "Transaction Detail by Account"; ?></h1>
       </div>
         ...
         <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
            ...
            <li class="active" style="color:orange;"><?php echo "Transaction Detail by Account"; ?></li>
               ...
               <div class="panel-body" style='height:60px;'>
                  <div class="row" id="">
                     <div class="col-sm-12" style='height:10px;'>
                        ...
                        <?php echo form_open_multipart('accounts/transcation_details', array('class' => 'form-vertical', 'id' => 'insert_sale', 'name' => 'insert_sale')) ?>
                        <?php
                           $today = date('Y-m-d');
                        ?>            
               ...
               <div class="panel-body">
                     <table class="print-table " width="100%">
                        <tr>
                           <td style='height:10px;padding: 0px;' colspan="3" align="center">
                              <h2 class="statement"><?php echo "Transaction Detail by Account"; ?> </h2>
                           </td>
                        </tr>
                        <?php 
                            if(!empty($date)){ 
                    ...
                    <table width="80%" class="table_boxnew table-bordered" id="ProfarmaInvList" style='text-align:center;' cellpadding="0" cellspacing="0">
                      <thead class="sortableTable">
                          <tr data-toggle="collapse" data-target="#demo1" class="accordion-toggle sortableTable__header btnclr ">
                      ...
                      <tbody class="table-container sortableTable__body">
                          <?php
                          $type = "Invoice";
                          ...
                          <tr class="task-list-row">
                              <td colspan="6" class="hiddenRow 1 value" data-col="1">
                                  <div id="collapse<?php echo $s; ?>" class="panel-collapse collapse"> 
                                      <table class="table_boxnew table-bordered" cellpadding="0" cellspacing="0">
                                          <tbody>
                                              <?php 
                                              $totalInvoice = 0;
                                              foreach ($invoice_alldata as $key => $alldata) { 
                                                $totalInvoice += floatval(str_replace(',', '', $alldata->paid_amount));  
                                              ?>
                                              <tr class="task-list-row">
                                                  <td style="width: 319px;" class="1 value" data-col="1"></td>
                                                  <td style="width: 298px;" class="2 value" data-col="2"></td>
                                                  <td style="width: 204px;" class="3 value" data-col="3"><?php echo $alldata->date; ?></td>
                                                  <td style="width: 314px;" class="4 value" data-col="4"><?php echo $alldata->details; ?></td>
                                                  <td style="width: 244px;" class="5 value" data-col="5"><?php echo $currency . $alldata->paid_amount; ?></td>
                                                  <td class="6 value" data-col="6"><?php echo $currency .  $alldata->due_amount; ?></td>
                                              </tr>
                                              <?php } ?>

                                              <?php 
                                              $totalExpense = 0;
                                              foreach ($expense_list as $key => $list) { 
                                                  $totalExpense += floatval(str_replace(',', '', $list->paid_amount));  
                                              ?>
                                              <tr class="task-list-row">
                                                  <td style="width: 319px;" class="1 value" data-col="1"></td>
                                                  <td style="width: 298px;" class="2 value" data-col="2"></td>
                                                  <td style="width: 204px;" class="3 value" data-col="3"><?php echo $list->purchase_date; ?></td>
                                                  <td style="width: 314px;" class="4 value" data-col="4"><?php echo $list->details; ?></td>
                                                  <td style="width: 244px;" class="5 value" data-col="5"><?php echo $currency . $list->paid_amount; ?></td>
                                                  <td class="6 value" data-col="6"><?php echo $currency . $list->balance; ?></td>
                                              </tr>
                                              <?php } ?>
                                              
                                                <?php 
                                                  $totalServiceExpense = 0;
                                                  foreach ($serviceprovider as $key => $servicelist) { 
                                                    
                                                      $totalServiceExpense += floatval(str_replace(',', '', $servicelist->provider_amount));  
                                                  ?>
                                                  <tr class="task-list-row">
                                                      <td style="width: 319px;" class="1 value" data-col="1"></td>
                                                      <td style="width: 298px;" class="2 value" data-col="2"></td>
                                                      <td style="width: 204px;" class="3 value" data-col="3"><?php echo $servicelist->bill_date; ?></td>
                                                      <td style="width: 314px;" class="4 value" data-col="4"><?php echo $servicelist->memo_details; ?></td>
                                                      <td style="width: 244px;" class="5 value" data-col="5"><?php echo $currency . $servicelist->provider_amount; ?></td>
                                                      <td class="6 value" data-col="6"><?php echo $currency . $servicelist->balances; ?></td>
                                                  </tr>
                                                  <?php } ?>
                                              ...
                                              <tr class="task-list-row">
                                                  ...
                                                  <td style="font-weight: bold;" class="5 value" data-col="5">Total for <?php echo $alldata->bank_name; ?> Balance</td>
                          ...
                          <tr>
                              <td>No Transaction Data found</td>
                          </tr>
                          <?php } ?>
  ...
  doc.save("Transaction_Details_"+utc+".pdf");
}
   ...
   tab_text= tab_text.replace(/<a[^>]*>/g, "");
    ...
    return (sa);
         ...
         function storeVisibilityState() {
            var banktranscationdetaillistvisibilityStates = {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
                var isVisible = row.is(':visible');
                banktranscationdetaillistvisibilityStates[rowID] = isVisible;
            });
            // Store the visibility states in localStorage
            localStorage.setItem("banktranscationdetaillistvisibilityStates", JSON.stringify(banktranscationdetaillistvisibilityStates));
         }
         // Apply the stored visibility state on page load
         function applyVisibilityState() {
            var storedVisibilityStates = JSON.parse(localStorage.getItem("banktranscationdetaillistvisibilityStates")) || {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
