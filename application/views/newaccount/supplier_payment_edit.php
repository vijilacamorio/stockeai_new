...
<?php
   ...
   $CI->load->model('Accounts_model');
    ...
    $supplier_name = $this->db->select('supplier_name')->from('supplier_information')->where('supplier_id', $supplier_payment_edit[0]['account_name'])->get()->row()->supplier_name;
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active" style="color:orange"><?php echo  "Edit Supplier Payment" ?></li>
            </ol>
        </div>
    </section>
...
<div class="col-sm-12 col-md-12">
    ...
    <div class="panel panel-bd lobidrag">
        ...
        <div class="panel-heading" style='height:50px;'>
            ...
            <div class="panel-title">
                ...
                <h4>
                  ...
                  <a   href="<?php echo base_url('accounts/supplier_payment_manager') ?>" class="btnclr btn  m-b-5 m-r-2" style="color:white;float:right;" ><i class="ti-align-justify"> </i> <?php echo ('Manage Supplier Payments') ?> </a>
        ...
        <div class="panel-body">
                     ...
                     <?php echo  form_open_multipart('accounts/update_supplier_payment','id="validate"') ?>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                         ...
                         <input type="text" name="txtVNo" id="txtVNo" readonly value="<?php echo $supplier_payment_edit[0]['voucher_no']; ?>" class="form-control" placeholder="Voucher No">
                     </div>
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                         ...
                         <input type="date" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo $supplier_payment_edit[0]['date']; ?>" required>
 ...
 <option  value="<?php if($supplier_payment_edit[0]['pay_type']=='2'){ echo '2';}elseif($supplier_payment_edit[0]['pay_type']=='1'){ echo  '1';} ?>"  ><?php if($supplier_payment_edit[0]['pay_type']=='2'){  echo display('bank_payment');}elseif($supplier_payment_edit[0]['pay_type']=='1'){ echo display('cash_payment');} ?></option>
...
<input type="hidden"  name="cust_incremnt_id" value="<?php echo $supplier_payment_edit[0]['cust_incremnt_id']; ?>" >
                     ...
                     <option value="<?php echo $supplier_payment_edit[0]['bank']; ?>"><?php echo $supplier_payment_edit[0]['bank']; ?></option>
...
<option value="SoFi">SoFi</option>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input  name="txtRemarks" id="txtRemarks" value="<?php echo $supplier_payment_edit[0]['remark']; ?>" class="form-control"></input>
   ...
   <select name="supplier_id" id="supplier_id_1" class="form-control" onchange="load_supplier_code(this.value,1)" required>
    ...
    <option value="<?php echo $supplier_payment_edit[0]['account_name']; ?>"><?php echo $supplier_name; ?></option>
...
<option value="<?php echo html_escape($suplier->supplier_id);?>"><?php echo html_escape($suplier->supplier_name);?></option>
     ...
     <?php }?>
                                    ...
                                    <td><input type="text" name="txtCode" value="<?php echo $supplier_payment_edit[0]['account_id']; ?>" class="form-control "  id="txtCode_1" readonly=""></td>

                                    <td style="width:600px;"><span class="input-symbol-euro"><input type="number" name="txtAmount" style="width:600px;text-align:start;padding-left: 20px;" placeholder="0.00"  value="<?php echo $supplier_payment_edit[0]['g_total1']; ?>" class="form-control total_price text-right"  id="txtAmount_1" onkeyup="supplierRcvcalculation(1)" required></span>
                                ...
                                <tr>
                                  ...
                                  <td >
                                    ...
                                    <td class="text-right">
                                      ...
                                      <span class="input-symbol-euro">  <input type="text" id="grandTotal" class="form-control text-right " name="grand_total" value="<?php echo $supplier_payment_edit[0]['gtotal']; ?>" placeholder="0.00"  readonly="readonly" style="width:600px;text-align:start;padding-left: 20px;" /></span>
