...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo ('Debit Voucher Manager') ?></h1>
            <small><?php //echo display('debit_voucher') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active" style="color:orange"><?php echo  "Debit Voucher Manager" ?></li>
            </ol>
        </div>
    </section>
...
<div class="col-sm-4" style="display: flex; justify-content: space-between; align-items: left;">
                                 ...
                                 <a href="<?php echo base_url('accounts/debit_voucher') ?>" class="btnclr btn btn-default dropdown-toggle boxes filip-horizontal"   style="height:fit-content;"  ><i class="far fa-file-alt"> </i> <?php echo ('Create Debit Voucher ') ?> </a>
  ...
  <div class="col-sm-12">
        <div class="panel-body" style="margin-top: -35px;">
              ...
              <thead class="sortableTable">
                     ...
                     <th class="5 value" data-col="5" style="text-align:center;" >Action</th>
              </tr>
                </thead>
              <tbody class="sortableTable__body">
                <?php       foreach($crv as $j){    ?>
                    <tr>
                            ...
                            <td  data-col="5" class="5"  >     <a class="btnclr btn  btn-sm invoice_edit"  style="background-color: #3CA5DE; color: #fff;" href="<?php echo base_url()?>accounts/debit_edit/<?php echo  $j->cust_incremnt_id;  ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                    </tr>
                    <?php  }  ?>
                </tbody>
            </table>
...
<!--<script type="text/javascript" src="<?php echo base_url()?>my-assets/js/profarma.js"></script>-->
   ...
   <div id="myModal_colSwitch"  name="debit_voucher"      class="modal_colSwitch" >
   ...
   <!-- <input type="checkbox"  data-control-column="5"   class="5"      value="5"/>&nbsp;<?php echo display('Action')?><br><br> -->
   </div>
   </div>
   </section>
   </div>
...
<script>
    ...
    var localStorageName = "debit_voucher"; // Set your desired localStorage name
