        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                   <div class="panel-title" style='text-align:end;'>
                      <a  class="btnclr btn btn-default dropdown-toggle  boxes filip-horizontal "  href="<?php echo base_url('accounts/contra_voucher_manager') ?>" style="background-color: #3CA5DE; color: #fff; height:fit-content;"  id="s_icon">Manage Contra Voucher  </a>
                    <!--<h4>-->
...
$voucher_n = 'Contra-' . $newNumericPart;
?>
   ...
   <option value="<?php echo $acc1['ac_name'];?>"><?php echo $acc1['ac_name'];?></option>
         <?php }?>
                                        ...
                                        <td><input type="text" readonly  name="txtCode[]"  class="bnk_name form-control "  id="txtCode_1" ></td>
