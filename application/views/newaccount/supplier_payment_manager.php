...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo ('Supplier Payment Manager') ?></h1>
            <small><?php //echo display('debit_voucher') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('accounts') ?></a></li>
                <li class="active" style="color:orange"><?php echo  "Supplier Payment Manager" ?></li>
            </ol>
        </div>
    </section>
...
<div class="col-sm-4" style="display: flex; justify-content: space-between; align-items: left;">
                                 ...
                                 <a href="<?php echo base_url('accounts/supplier_payment') ?>" class="btnclr btn btn-default dropdown-toggle boxes filip-horizontal"   style="height:fit-content;"  ><i class="far fa-file-alt"> </i> <?php echo ('Create Supplier Payment') ?> </a>
                     ...
                     <table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList">
                        ...
                        <tr  class="sortableTable__header btnclr"  >
                                 ...
                                 <tbody>
                                          ...
                                          <?php if (!empty($sp_info)) { ?>
    <?php foreach ($sp_info as $list) { ?>
...
<a class="btnclr btn  btn-sm invoice_edit"    href="<?php echo base_url()?>accounts/supplier_payment_edit/<?php echo  $list['cust_incremnt_id'];  ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
 

<a class="btnclr btn  btn-sm" onclick="return confirm('<?php echo display('are_you_sure') ?>')"   href="<?php echo base_url()?>accounts/supplier_payment_delete/<?php echo  $list['cust_incremnt_id'];  ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
...
<?php } else { ?>
 <?php } ?>
   ...
   <div id="myModal_colSwitch"  name="mysupplierpaymentName"      class="modal_colSwitch" >
...
$(document).ready(function() {
    ...
    var localStorageName = "mysupplierpaymentName"; // Set your desired localStorage name
