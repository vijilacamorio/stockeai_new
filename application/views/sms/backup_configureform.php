                  ...
                  <?php echo form_open_multipart('Csms/add_update_configure', array('class' => 'form-vertical','id' => 'sms_configuration'))?>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                     ...
                     <?php   //   if($this->permission1->method('configure','update')->access()){ ?>
                         <div class="form-group row">
                            <label for="example-text-input" class="col-sm-4 col-form-label"></label>
                            <div class="col-sm-6">
                                <input type="submit" id="sms" class="btn" style="background-color:#38469f;color:white;" name="save_changes" value="<?php echo display('save') ?>" tabindex="13"/>
                            </div>
                         </div>
                        <?php //} ?>
