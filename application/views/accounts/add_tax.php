         ...
         <div class="panel panel-bd lobidrag"  style="border:3px solid #d7d4d6;"  >
            ...
            <div class="panel-body">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-1">
                     <input type="text" class="form-control" name="enter_tax" id="enter_tax" step="0.01"  required="" placeholder="" />
                  </div>
                  <div class="col-sm-2">
                     <i class="text" style="margin-left: -25px;font-size: 18px;">%</i>
                  </div>
               </div>
               <div class="form-group row"> 
                  <label for="description" class="col-sm-3 col-form-label"><?php echo display('Description') ?></label>
                  <div class="col-sm-6">
                     <textarea class="form-control" name="description"  style="border:2px solid #d7d4d6;width:300px;width:270px;margin-left: 5px;"   id="description"></textarea>
                  </div>
               </div>
               <div class="form-group row">
                  <label for="tax_agency" class="col-sm-3 col-form-label">State<i class="text-danger">*</i></label>
                  <div class="col-sm-6">
                    <select name="state" class="form-control"   style="border:2px solid #d7d4d6;width:300px;margin-left: 5px;"   required>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <select name="tax_agency"   style="border:2px solid #d7d4d6;width:300px;margin-left: 5px;"    class="form-control" required>
               ...
               <div class="checkbox_toggle">
                  <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <select name="account" style="border:2px solid #d7d4d6;width:300px;margin-left: 5px;" class="form-control" required>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <select name="show_taxonreturn" style="border:2px solid #d7d4d6;width:300px;margin-left: 5px;" class="form-control" required>
