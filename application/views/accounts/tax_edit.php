            ...
            <div class="panel-body" >
               ...
               <div class="form-group row">
                  <div class="col-sm-6 sale_checkbox">
                     <div class="col-sm-1"> 
                        <input type="checkbox" name="status_type" id="sales_tax" class="form-control"  style="border:2px solid #d7d4d6;"  value="sales" <?php if($status_type == 'sales') echo " checked "?>>
                     </div>
                  ...
                  <div class="col-sm-6 sale_checkbox">
                     <div class="col-sm-1"> 
                        <input type="checkbox" name="status_type" id="purchase_tax"   style="border:2px solid #d7d4d6;"  class="form-control" value="expenses" <?php if($status_type == 'expenses') echo " checked "?>>
                     </div>
                     <label for="isshow" class="col-sm-1 col-form-label">Expenses</label>
                  </div>
               </div>
               <input type="hidden" name="status_type" class="update_myInput">
               <div class="form-group row">
                  <label for="enter_tax" class="col-sm-3 col-form-label">Enter Tax percent<i class="text-danger">*</i></label>
                  <div class="col-sm-1">
                     <input type="text" class="form-control" name="enter_tax" id="enter_tax" step="0.01"   style="border:2px solid #d7d4d6;width:270px;margin-left: 5px;"    required="" placeholder="" value="<?php echo html_escape($tax)?>" />
                  </div>
                  <div class="col-sm-2">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                     <textarea class="form-control" name="description" style="border:2px solid #d7d4d6;width:297px;height:38px;margin-left: 5px;"  id="description" value="<?php echo html_escape($description)?>"><?php echo html_escape($description)?></textarea>
                  </div>
               </div>
                <div class="form-group row">
                  <label for="tax_agency" class="col-sm-3 col-form-label">State<i class="text-danger">*</i></label>
                  <div class="col-sm-6">
                    <select name="state" class="form-control"    style="border:2px solid #d7d4d6;width:300px;margin-left: 5px;"   >
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <select name="tax_agency" class="form-control" style="border:2px solid #d7d4d6;width:300px;margin-left: 5px;" >
               ...
               <div class="checkbox_toggle">
                  <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <select name="account" style="width:300px;border:2px solid #d7d4d6;" class="form-control" required>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <select name="show_taxonreturn" style="width:300px;border:2px solid #d7d4d6;" class="form-control" required>
               ...
               <div class="form-group row">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-6">
                        <input type="submit" id="add-deposit" class="btnclr btn"  style="background-color:#424f5c;margin-left: 15px;"name="add-deposit" value="<?php echo display('save') ?>" />
                     </div>
                  </div>
               </div>
               <?php echo form_close()?>
...
<script>
    ...
    $("#add-deposit").on("click", function() {
      if ($('#update_tax :checkbox:checked').length > 0){
    $('input[name="status_type"]:checked').each(function(){
      var checkboxValue = $(this).val();
      if(checkboxValue){
        $(".update_myInput").val(checkboxValue); 
     }
    });

}else{
     $(".update_myInput").val("Both"); 
}
