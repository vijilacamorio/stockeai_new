...
<a style="background-color:#38469f;color:white;" href="<?php echo base_url('Csupplier/manage_supplier') ?>" class="btn  m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo ('Manage Supplier') ?> </a>
                    ...
                    <a href="<?php echo base_url('assets/data/csv/supplier_csv_sample.csv') ?>" style="color:white;background-color:#38469f;" class="btn btn-primary pull-right"><i class="fa fa-download"></i> <?php echo display('download_sample_file')?></a>
                       ...
                       <span class="text-warning">The first line in downloaded csv file should remain as it is. Please do not change the order of columns.</span><br>The correct column order is <span class="text-info">(Vendor Name,Primary Email,Secondary Email,Mobile Number,Business Phone Number,Fax,Contact,City,State,Zipcode,Country,Address1,Address2,Previous Balance,Credit Limit)</span> &amp; you must follow this.<br>Please make sure the csv file is UTF-8 encoded and not saved with byte order mark (BOM).<p>The images should be uploaded in <strong>uploads</strong> folder.</p>
                    </div>
                </div>
            </div>
        </div>
