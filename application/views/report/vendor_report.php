...
<script>
            $(document).ready(function() {
                ...
                if ($.fn.DataTable.isDataTable('#vendorRepTbl')) {
                    $('#vendorRepTbl').DataTable().clear().destroy();
                }
                var csrfName = '<?php echo $this->security->get_csrf_token_name(); ?>';
                var csrfHash = '<?php echo $this->security->get_csrf_hash(); ?>';
                var dtable = $('#vendorRepTbl').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "lengthMenu": [
                        [10, 25, 50, 100],
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('Creport/purchaseByvendorListgetData?id='); ?>" +
