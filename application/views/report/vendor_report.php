...
<div class="content-wrapper">
   <section class="content-header">
      <div class="header-icon">
         ...
         <figure class="one">
          ...
          <h1><?php echo 'Purchase By Vendor' ?></h1>
       </div>
         ...
         <li><a href="<?php echo base_url()?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
            ...
            <li class="active" style="color:orange"><?php echo 'Purchase By Vendor';?></li>
   ...
   <section class="content">
      ...
      <?php  
         ...
         foreach ($supplier_name as $invoice) {
         ...
         <div class="col-sm-12">
               ...
               <table class="table" align="center">
                  <tr style='text-align:center;font-weight:bold;' class="filters">
                     ...
                     <td style='width:100px;' class="search_dropdown">
                        <span><?php echo 'Vendor Name'; ?></span>
                        <select id="customer-name-filter" style='width:200px;' class="form-control">
               ...
               <table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList">
                  ...
                  <tbody class="sortableTable__body" id="tab">
                     ...
                     <tr style="text-align:center" class="task-list-row" data-task-id="<?php echo $count; ?>" data-pname="<?php echo $arr['chalan_no'];  ?>" data-model="<?php echo $status; ?>" data-category="<?php echo $arr['supplier_name']; ?>" data-unit="<?php echo $arr['date'] ?>" data-supplier="<?php echo $arr['payment_due_date'];  ?>">
                        ...
                        <td data-col="1" class="1 value" style="text-align:center;"><?php   echo $arr['chalan_no'];  ?></td>
...
$(document).ready(function() {
  ...
  doc.save("Vendor_Report_"+utc+".pdf");
}
...
<script type="text/javascript">
         ...
         function storeVisibilityState() {
            var purchasevendorlistvisibilityStates = {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
                var isVisible = row.is(':visible');
                purchasevendorlistvisibilityStates[rowID] = isVisible;
            });
            // Store the visibility states in localStorage
            localStorage.setItem("purchasevendorlistvisibilityStates", JSON.stringify(purchasevendorlistvisibilityStates));
         }
         // Apply the stored visibility state on page load
         function applyVisibilityState() {
            var storedVisibilityStates = JSON.parse(localStorage.getItem("purchasevendorlistvisibilityStates")) || {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
