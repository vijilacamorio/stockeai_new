                                 ...
                                 <table class="table"  id="ProfarmaInvList">
                                    ...
                                    <tbody class="sortableTable__body">
                                       ...
                                       <tr class="task-list-row">
                                          <td data-col="1" class="1 value" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->category_name); ?></td>
                                          <td data-col="2" class="2 value" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->product_name); ?></td>
                                          <td data-col="3" class="3 value" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->product_model); ?></td>
                                          <td data-col="4" class="4 value" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->purchase_date); ?></td>
                                          <td data-col="5" class="5 value" bgcolor="<?php echo $bg; ?>"><?php echo html_escape($single->p_quantity); ?></td>
                                          <td class="6" data-col="6 value" bgcolor="<?php echo $bg; ?>"><?php echo (($position == 0) ? $currency.' '.number_format($single->total_amount,2) : number_format($single->total_amount,2).' '. $currency);
                                       ...
                                       <tr class="task-list-row">
                                          ...
                                          <td data-col="3" class="3 value">&nbsp; </td>
                                          <td data-col="4" class="4 value">&nbsp; </td>
                                          <td  class="5" data-col="5 value" style="text-align:right;"><b><?php echo display('total_seles') ?></b></td>
                                          <td class="6" data-col="6 value"><b><?php echo (($position == 0) ? $currency.' '.number_format($total,2) : number_format($total,2).' '. $currency) ?></b></td>
                                       </tr>
                                       <?php   } else {
                                          ?>
                                       <tr>
...
<script type="text/javascript">
         ...
         function storeVisibilityState() {
            var CategorywisepurchasereportlistvisibilityStates = {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
                var isVisible = row.is(':visible');
                CategorywisepurchasereportlistvisibilityStates[rowID] = isVisible;
            });
            // Store the visibility states in localStorage
            localStorage.setItem("CategorywisepurchasereportlistvisibilityStates", JSON.stringify(CategorywisepurchasereportlistvisibilityStates));
         }
         // Apply the stored visibility state on page load
         function applyVisibilityState() {
            var storedVisibilityStates = JSON.parse(localStorage.getItem("CategorywisepurchasereportlistvisibilityStates")) || {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
