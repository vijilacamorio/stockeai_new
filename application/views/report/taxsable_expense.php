...
<div class="content-wrapper">
    <section class="content-header"  style="height: 74px;">
        <div class="header-icon">
          ...
          <h1 style="margin-top: 11px;"><strong><?php echo 'Taxsable Expense Details' ?><strong></h1>
       </div>
            ...
            <ol class="breadcrumb"   style=" border: 3px solid #d7d4d6;"   >
                ...
                <li class="active" style="color:orange;"><?php echo 'Taxable Expense' ?></li>
      ...
      <div class="panel-body"   >
               ...
               <div id="for_filter_by" class="for_filter_by" style="display: inline;">
                  ...
                  <select id="filterby" style="border-radius:5px;height:25px;" >
                     ...
                     <option value="1"><?php echo 'Bill No' ?></option>
...
<table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList">
    <thead class="sortableTable">
        <tr class="sortableTable__header btnclr">
            ...
            <th class="1 value"  style="color:white;"  data-col="1" data-control-column="1">Bill NO</th>
            <th class="4 value" style="color:white;"  data-col="4"><?php echo 'Total Amount' ?></th>
            <th class="2 value" style="color:white;"  data-col="2" data-control-column="2"><?php echo 'Tax' ?></th>
            <th class="3 value" style="color:white;"  data-col="3" data-control-column="3"><?php echo 'Tax Agency' ?></th>
...
if (count($tax_parts) > 1) {
    ...
    $tax_id = trim($product['total_tax']);
                ...
                <tr>
                    ...
                    <td data-col="1" style="text-align:center;" class="1"><?php echo $product['chalan_no']; ?></td>
                    <td  data-col="4" class="4" style="text-align:center; white-space:nowrap;"><?php echo $product['grand_total_amount']; ?></td>
       ...
       // print_r($tax_inf);
        if ($ser_exp_tax) {
            foreach ($ser_exp_tax as $product) {
                // Extract the tax_id from the total_tax field
         $product['total_tax']=       preg_match('/\((.*?)\)/', $product['total_tax'], $matches);
                $tax_i = trim($matches[1]);
                $tax_id='';
...
if (count($tax_parts) > 1) {
    ...
    // Handle cases where there's no hyphen in the total_tax string
    $tax_id = trim($product['tax_detail']);
}
                // Search for a matching tax_id in the $tax_inf array
                $tax_agency = ''; // Initialize it as an empty string
                ...
                <tr>
                    ...
                    <td data-col="1" style="text-align:center;" class="1"><?php echo $product['bill_number']; ?></td>
                    <td data-col="4" class="4" style="text-align:center; white-space:nowrap;"><?php echo $product['gtotals']; ?></td>
                    <td data-col="2" class="2"><?php echo $tax_i; ?></td>
                    <td data-col="3" class="3"><?php echo $tax_agency; ?></td>
                      <td data-col="5" class="5"><?php echo $taxInfo['description']; ?></td>
                </tr>
