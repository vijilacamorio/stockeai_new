   ...
   <section class="content-header">
      <div class="header-icon">
         ...
         <figure class="one">
          ...
          <h1><?php echo 'Payable Ageing Details' ?></h1>
       </div>
         ...
         <ol class="breadcrumb"   style=" border: 3px solid #d7d4d6;"   >
            ...
            <li class="active" style="color:orange"><?php echo 'Payable Ageing Details';?></li>
               ...
               <table class="table table-bordered" cellspacing="0" width="100%" id="ProfarmaInvList" >
                  <thead class="sortableTable">
                     <tr  class="sortableTable__header btnclr">
                        ...
                        <th class="2 value" data-col="2"    style="width: 198.011px; text-align:center;"       ><?php echo 'Purchase Date'?></th>
                  ...
                  <tbody class="sortableTable__body" id="tab">
                     <?php
                        //   print_r($get_all_invoice_sale);
                              $count=1;
                                if($get_all_invoice_sale){
                               foreach($get_all_invoice_sale as $arr){
                                 $status='';
                                 if($arr['gtotal']==$arr['paid_amount'] && ($arr['balance']=='0' || $arr['balance']=='0.00' )){
                                     $status='Paid';
                                 }else if($arr['gtotal'] != $arr['paid_amount'] && $arr['paid_amount'] !=='0.00'  && $arr['paid_amount'] !=='0' && substr($arr['balance'], 0, 1) !== '-'){
...
<script>
 $(document).ready(function() {
  ...
  doc.save("Account_Payable_Ageing_"+utc+".pdf");
}
