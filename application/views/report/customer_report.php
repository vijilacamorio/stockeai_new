...
<div class="content-wrapper">
   <section class="content-header">
      <div class="header-icon">
         ...
         <h1><?php echo 'Sales By Customer' ?></h1>
       </div>
         ...
         <ol class="breadcrumb" style="border: 3px solid #d7d4d6;" >
            ...
            <li class="active" style="color:orange"><?php echo 'Sales By Customer';?></li>
   ...
   <section class="content">
      ...
      <div class="row">
         <div class="col-sm-12 panel panel-bd lobidrag"     style="border: 3px solid #d7d4d6;    height: 80px;"         >
            <div class="col-sm-10">
         <div class="col-sm-8">
               ...
               <div class="panel-body">
                  ...
                  <table class="table table-bordered" id="ProfarmaInvList" cellspacing="0" width="100%">
                     <thead class="sortableTable">
                        ...
                        <th class="1 value"  data-col="1"  style="text-align:center;    width: 170px;"   > <?php echo display('Invoice No')?></th>
                        <th class="2 value" data-col="2"  style="text-align:center;    width: 180px;"  ><?php echo display('Sales Invoice date')?></th>
                        <th class="3 value" data-col="3" style="text-align:center;    width: 165px;"  ><?php echo display('Grand Total')?></th>
                        <th class="4 value" data-col="4"  style="text-align:center;    width: 210px;" ><?php echo 'Customer Name ';?></th>
                        <th class="5 value" data-col="5"  style="text-align:center;    width: 180px;"  ><?php echo 'Payment Due Date';?></th>
                        <th class="6 value" data-col="6"  style="text-align:center;    width: 175px;" ><?php echo 'Past Due';?></th>
                        <th class="7 value" data-col="7"  style="text-align:center;    width: 175px;" ><?php echo display('Amount Paid')?></th>
                        <th class="8 value" data-col="8"  style="text-align:center;    width: 165px;"  ><?php echo display('Balance Amount')?></th>
                        <th class="9 value" data-col="9"  style="text-align:center;    width: 165px;"  ><?php echo 'Status';?></th>
                     </tr>
                  </thead>
                  <tbody class="sortableTable__body" id="tab">
                     ...
                     <?php   
                        $count++;
                            ...
                            ?>
                     <tr>
                        <td colspan="10" style="text-align:center;font-weight:bold;"><?php  echo "No Records Found"  ;?></td>
                     </tr>
                     <?php
                        }
...
<script>
 $(document).ready(function() {
  ...
  doc.save("Customer_Report_"+utc+".pdf");
}
...
<script type="text/javascript">
         ...
         function storeVisibilityState() {
            var customerreportlistvisibilityStates = {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
                var isVisible = row.is(':visible');
                customerreportlistvisibilityStates[rowID] = isVisible;
            });
            // Store the visibility states in localStorage
            localStorage.setItem("customerreportlistvisibilityStates", JSON.stringify(customerreportlistvisibilityStates));
         }
         // Apply the stored visibility state on page load
         function applyVisibilityState() {
            var storedVisibilityStates = JSON.parse(localStorage.getItem("customerreportlistvisibilityStates")) || {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
