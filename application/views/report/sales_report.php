                                 ...
                                 <table class="table table-stripped"  id="ProfarmaInvList">
                                    <thead class="sortableTable">
                                       <tr style="background-color: #337ab7;border-color: #2e6da4;" class="sortableTable__header">
                                          ...
                                          <th data-col="2" class="2 value" name="Invoice ID" style="height: 35.0114px;">Invoice ID</th>
                                          <th data-col="3" class="3 value" name="Customer Name" style="height: 35.0114px;">Customer Name</th>
                                          <th data-col="4" class="4 value" name="Total Amount" style="height: 35.0114px;">Total Amount<?php echo form_open('Admin_dashboard/retrieve_dateWise_SalesReports', array('class' => 'form-inline', 'method' => 'get')) ?>
                                    ...
                                    <tbody class="sortableTable__body">
                                       ...
                                       <tr class="task-list-row">
                                          ...
                                          <td data-col="4" class="4 value" bgcolor="<?php echo $bg; ?>">
                                             <?php 
                                                if($position == 0){
                                       ...
                                       <?php $i++;} ?>
                                       <tr class="task-list-row">
                                          <td class="1" data-col="1 value">&nbsp;</td>
                                          <td class="2" data-col="2 value">&nbsp;</td>
                                          <td class="3" data-col="3 value" ><b><?php echo display('total_seles') ?></b></td>
                                          <td class="4" data-col="4 value"><b><?php echo (($position == 0) ? "$currency ". number_format($subtotal) : number_format($subtotal) ." $currency") ?></b></td>
                                       </tr>
                                       <?php } else {
                                          ?>
                                       <tr>
...
<script type="text/javascript">
         ...
         function storeVisibilityState() {
            var SalesReportlistvisibilityStates = {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
                var isVisible = row.is(':visible');
                SalesReportlistvisibilityStates[rowID] = isVisible;
            });
            // Store the visibility states in localStorage
            localStorage.setItem("SalesReportlistvisibilityStates", JSON.stringify(SalesReportlistvisibilityStates));
         }
         // Apply the stored visibility state on page load
         function applyVisibilityState() {
            var storedVisibilityStates = JSON.parse(localStorage.getItem("SalesReportlistvisibilityStates")) || {};
            $("#ProfarmaInvList tr").each(function(index, element) {
                var row = $(element);
                var rowID = index;
