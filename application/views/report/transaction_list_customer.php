...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <?php  
        ...
        foreach ($customer_info as $invoice) {
        $commercial_invoice_number [] = $invoice['c_name'];
        }
               ...
               <div class="panel-body" style='margin-bottom:-30px;'>
                  <table class="table1 table-bordered" cellspacing="0" width="100%" style='border:none;'>
                     <tr style="text-align: center; font-weight: bold;" class="filters">
                        ...
                        <td class="search_dropdown" style="width: 100px; padding: 5px;">
                        ...
                        <td style="width: 20px; padding: 5px;">
                           <input type="submit" id="search" name="btnSave" class="btn btnclr" value="Search" />
                        </td>
                        <td style="width: 100px;"></td>
                     </tr>
                  </table>
                  ...
                  <table class="table table-bordered" id="ProfarmaInvList" cellspacing="0" width="100%">
                     <thead class="sortableTable">
                        <tr class="sortableTable__header btnclr">
                           <th class="1 value" data-col="1">Customer Name</th>
                           ...
                           if ($customer_info) {
                               ...
                               foreach ($customer_info as $arr) {
                                   ...
                                   // Display the "Supplier Name" only when it changes
                                       ...
                                       echo '<td class="1 value" data-col="1">' . $arr['c_name'] . '</td>';
                                  
                                
                           
                                   // Display the "Invoice Number" only when it changes
                                  
                                       echo '<td class="2 value" data-col="2">' . $arr['commercial_invoice_number'] . '</td>';
                                   ...
                                   echo '<td data-col="5" class="5 value" style="text-align:center;">' . $currency . $arr['total_amt'] . '</td>';
                                   echo '<td data-col="6" class="6 value" style="text-align:center; text-wrap: nowrap;">' .$currency . $arr['amt_paid'] . '</td>';
                                   echo '<td data-col="7" class="7 value" style="text-align:center;">' . $currency . $arr['balance'] . '</td>';
                                   echo '<td data-col="8" class="8 value" style="text-align:center;">' . $arr['details'] . '</td>';
                                   echo '<td data-col="9" class="9 value" style="text-align:center;">' ;
                                   if ($status == 'Paid') {
