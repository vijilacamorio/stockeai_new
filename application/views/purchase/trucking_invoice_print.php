...
<?php
    ...
    <div class="col-sm-4" style="color:white;font-weight:bold;" id='company_info'>
       ...
       <?php if(empty($header)){ ?>
  <div class="col-sm-5 text-center" style="color:white;"><h3><?php echo "ROAD TRANSPORT"; ?></h3></div>
 <?php } 
else
{  ?>
 ...
 elseif($template==2)
{
   ...
   <?php if(empty($header)){ ?>
  <div class="col-sm-6 text-center" style="color:white;"><h3><?php echo "ROAD TRANSPORT"; ?></h3></div>
 <?php } 
else
{  ?>
...
<div class="row">
         ...
         <?php if(empty($header)){ ?>
  <div class="col-sm-2 text-center" style="color:white;"><h3><?php echo "ROAD TRANSPORT"; ?></h3></div>
 <?php } 
else
{  ?>
