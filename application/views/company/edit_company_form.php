        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <form  id="company_update"  method="post" >     

                    <div class="panel-body">
                        <div class="form-group row">
                        <label class="col-sm-3 col-form-label"><?php echo display('Company Name') ?><i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="2" class="form-control" name="company_name" id="company_name" value="{company_name}"    required tabindex="1"/>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" tabindex="1" class="form-control" value="<?php  echo $c_city; ?>" name="c_city" id="c_city" required   />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label"><?php echo 'State'; ?><i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="1" class="form-control" value="{c_state}" name="c_state" id="c_state" required    />
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div id="outputsstx"></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <a href="<?php echo base_url('Company_setup/manage_company') ?>?id=<?php echo $encodedId; ?>"  style="margin-top:-5px;"  class="btn btn-info">Cancel</a>
                                    </div>
                                </div>
                            </div>
                    </form>
...
$("#company_update").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url('user/company_update_branch/'.$c_id); ?>",
        data: formData,
        contentType: false,
        processData: false,
