        ...
        <div class="header-title">
            ...
            <ol class="breadcrumb">
              <li><a href="<?php echo base_url(); ?>"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                ...
                <li class="active" style="color:orange"><?php  echo "Add Role" ?></li>
            </ol>
        </div>
    </section>
...
<div class="row">
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <div class="alert alert-danger alert-dismissable" id="validationStatus"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button></div> </div>
                    </div>
                     <?php echo form_open("Permission/insert_rolepermission/",array('name' =>'adminRoles','id'=>'adminRoles')) ?>
                    <div class="panel-body">
                    <div class="errormessage"></div>
                         <div class="form-group row">
                            <label for="type" class="col-sm-3 col-form-label"><?php echo display('role_name') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="2" class="form-control" name="rolename" id="type" placeholder="<?php echo display('role_name') ?>" />
                            </div>
                        </div>
                        <div class="panel-body">
    ...
    <thead>
        <tr>
            <th style="text-align: center; width: 50%; background-color: #424f5c; color: #fff;"><?php echo 'Name'; ?></th>
            <th style="text-align: center; background-color: #424f5c; color: #fff;"><?php echo 'Access Permission'; ?></th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($accounts as $key => $value2) : ?>
            <tr style="text-align: center;">
                <td><?php echo htmlspecialchars($value2['name']); ?></td>
                <td><input type="checkbox" name="<?php echo htmlspecialchars($value2['name']); ?>_create"></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
                        <div class="form-group text-center" >
                        <button type="reset" class="btnclr btn  btn-sm" style="background-color: #424f5c;color:#fff;" ><?php echo display('reset') ?></button>
                        <button type="submit"    class="btnclr btn  btn-sm" style="background-color: #424f5c;color:#fff;" ><?php echo display('save') ?></button>
 </div>
            <?php echo form_close() ?>
                    </div>
                </div>
...
function validateForm(evt) {
 ...
 setTimeout(() => {
  ...
  $.ajax({
            url: '<?php echo base_url('permission/insert_rolepermission'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            cache: false,
