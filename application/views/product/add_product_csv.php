...
<a style="background-color:#38469f;color:white;" href="<?php echo base_url('Cproduct/manage_product') ?>" class="btn  m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo ('Manage Product') ?> </a>
                    ...
                    <div class="panel-body">
                       <a href="<?php echo base_url('assets/data/csv/sample_product.csv') ?>" class="btn btn-primary pull-right"  style="background-color:#38469f;color:white;"    ><i class="fa fa-download"></i> Download Sample File</a>
                            <span class="text-warning">The first line in downloaded csv file should remain as it is. Please do not change the order of columns.</span><br>The correct column order is <span class="text-info">(Supplier Name,Product Name,Category Name,Sale Price,Supplier Price,Barcode,Quantity,Unit,Product Subcategory,Account Categoryname,Account Subcategory,Sales Description,SKU,Type,Taxable,Income Account,Purchase Description,Expense Account,Reorder Point,Inventory Asset Account,Quantity as-of Date)</span> &amp; you must follow this.<br>Please make sure the csv file is UTF-8 encoded and not saved with byte order mark (BOM).<p>The images should be uploaded in <strong>uploads</strong> folder.</p>
                    </div>
                </div>
            </div>
        </div>
