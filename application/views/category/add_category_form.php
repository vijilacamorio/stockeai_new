                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'Cproduct/manage_product/{category_id}'; ?>" id="{category_id}" name="category" class="btn btn-info btn-sm category_id" data-toggle="tooltip" data-placement="left" title="Category Product List"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                    <?php }?>
