                      ...
                      <div class="container">
                          <div class="row">
                              <div class="col-sm-4  "> <div class="panel panel-default">
                                <label style="margin-left:25px;margin-top: 30px;"><?php echo display('Invoice Header') ?></label>
    <div class="panel-body"> 
      <input type="text" class='form-control' onblur="header(this.value)" name="header"  id='header'>
        <br
...
<br>
        ...
        $colors = array("CadetBlue"  =>"5F9EA0",
                        ...
                        ?>
<table width="310" border="2" id="colorcombo">
  <tbody>
    <?php  foreach ($colors as $key => $value) { ?>
    <tr>
     <td  style="background-color:#<?php echo $value; ?>;" onclick="dot('<?php echo $value; ?>')" > <a class='colorpad' style="color:#000;"  ><?php echo $key; ?></a></td>
    </tr>
   <?php } ?>
       </tbody>
     </table>
  ...
  <div class="col-sm-8" > <div class="panel panel-default" style="height: 710px;">
    <div class="panel-body">
      ...
      </br> <textarea name="example" id="example"></textarea><br/>
...
<?php   } elseif($template==2)    {   ?>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-3"><img src="<?php echo base_url().$logo; ?>" style='width: 40%;'>
              </div>
 ...
 <div class="col-sm-8" > 
    <div class="panel panel-default" style="height: 710px;">
    <div class="panel-body">
        <div class="row">
      ...
      <div >
       ...
       <div class="col-sm-8" > <div class="panel panel-default">
        ...
        <div class="row">
            <br>
            <br>
        <table width="348" height="79" border="1" style="color: #000;"><tr>
